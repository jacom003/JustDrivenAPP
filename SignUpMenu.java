...
public class SignUpMenu implements ActionListener
{
	...
	JLabel label_username = new JLabel("Enter User Name: ");
	...
	public SignUpMenu()
	{
		...
		label_username.setBounds(50,126,200,25);
		label_password.setBounds(50,151,200,25);
		label_confirmpass.setBounds(50,176,120,25);
		label_contactNumber.setBounds(50,201,100,25);
		...
		field_username.setBounds(185,126,100,25);
		field_password.setBounds(185,151,100,25);
		field_confirmpass.setBounds(185,176,100,25);
		field_contactNumber.setBounds(185,201,100,25);
	
		//button window bounds configuration
		signup_rider.setBounds(50,250,100,25);
		signup_driver.setBounds(175,250,100,25);
		...
		accountForm.add(label_username);
		...
		accountForm.add(field_username);
